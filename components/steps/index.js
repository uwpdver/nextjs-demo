  ...
  const stepRender = ({ title }, index) => {
    return (
      <div className={classNames('overflow-x-hidden step-item flex-1 pl-4 first:pl-0 last:flex-none group', className)} key={index}>
        <div>
          <div className={classNames('step-item-title relative inline-block pr-4 group-last:pr-0 after:bg-gray-800 after:absolute after:left-full after:top-1/2 after:w-[9999px] after:h-[1px] after:content-[ ]', {
